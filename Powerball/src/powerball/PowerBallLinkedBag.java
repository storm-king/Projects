...
public class PowerBallLinkedBag {
    ...
    public PowerBallLinkedBag(LinkedBag<Integer> whiteBalls, int redBall)
    {
    ...
    public int getWinnings( PowerBallLinkedBag winningTicket )
    {
        int winnings = 0;
